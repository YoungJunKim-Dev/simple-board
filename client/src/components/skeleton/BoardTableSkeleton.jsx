const BoardTableSkeleton = () => {
  return (
    <tr className="animate-pulse">
      <td className="border-b border-slate-100 p-4 pl-8 text-slate-500 dark:border-slate-700 dark:text-slate-400">
        <div className="my-3 h-4 rounded bg-slate-100 dark:bg-slate-700" />
      </td>
      <td className="border-b border-slate-100 p-4 text-slate-500 hover:cursor-pointer hover:font-semibold hover:underline dark:border-slate-700 dark:text-slate-400">
        <div className="my-3 h-4 rounded bg-slate-100 dark:bg-slate-700" />
      </td>
