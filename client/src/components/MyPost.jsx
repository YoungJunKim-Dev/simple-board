...
const MyPost = (props) => {
  ...
  return (
    <tr className="hover:bg-slate-50 dark:hover:bg-slate-700">
      <td className="border-b border-slate-100 p-1 text-center text-slate-500 dark:border-slate-700 dark:text-slate-400 sm:p-2 sm:pl-4">
        <div className="text-sm leading-5 text-gray-500">{post_id} </div>
      </td>
      <td className="border-b border-slate-100 p-1 text-left text-slate-500 dark:border-slate-700 dark:text-slate-400 sm:p-2">
        <div className="text-sm leading-5 text-gray-500">{title} </div>
      </td>

      <td className="border-b border-slate-100 p-1 text-center  text-slate-500 dark:border-slate-700 dark:text-slate-400 sm:p-2">
