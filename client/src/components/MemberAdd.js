...
function MemberAdd() {
  ...
  const onChange = (e) => {
    ...
    setContents({ ...contents, [targetName]: targetValue });
  };
        ...
        <Stack direction="row" spacing={2}>
          ...
          <Box sx={{ minWidth: 120 }}>
            <FormControl fullWidth>
              <InputLabel id="demo-simple-select-label">가입수단</InputLabel>
              <Select
                labelId="demo-simple-select-label"
                id="demo-simple-select"
                name="signUpType"
                value={contents.signUpType ? contents.signUpType : ""}
                label="가입수단"
                onChange={handleChange}
              >
                <MenuItem value={"G"}>Google</MenuItem>
                <MenuItem value={"N"}>Naver</MenuItem>
                <MenuItem value={"K"}>Kakao</MenuItem>
              </Select>
            </FormControl>
          </Box>
        </Stack>
